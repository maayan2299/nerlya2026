...
import { Plus, Trash2, Edit3, Save, X, Package, TrendingUp, Upload, Image as ImageIcon, Tag, Images, LogOut, Eye, EyeOff } from 'lucide-react';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            פרטי התחברות: nerlya / nerlya2026
          </p>
        </div>
      </div>
    );
        ...
        <div className="modal-overlay" onClick={closeImageManager}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              ...
              <button onClick={closeImageManager} style={{
                background: 'none',
                border: 'none',
                cursor: 'pointer',
                padding: '4px'
              ...
              <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize: '14px',
                    fontWeight: '600',
                    opacity: (!newImageFile || uploading) ? 0.5 : 1
                  }}
                >
                  {uploading ? 'מעלה...' : 'הוסף'}
                </button>
        ...
        <div className="modal-overlay" onClick={closeColorManager}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              ...
              <button onClick={closeColorManager} style={{
                background: 'none',
                border: 'none',
                cursor: 'pointer',
                padding: '4px'
                    ...
                    {newColor.code && (
                      <div 
                        style={{
                          ...
                          height: '30px',
                          border: '1px solid #000',
                          backgroundColor: newColor.code.startsWith('#') ? newColor.code : `#${newColor.code}`
                        }}
                      />
                    )}
                  </div>
                    ...
                    <div key={product.id} style={{
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '12px', color: '#666' }}>
                            {product.category_name} • מלאי: {product.stock_quantity || 0}
                          </div>
                        </div>
                      </div>
                        ...
                        {editingProduct === product.id ? (
                          <>
                            ...
                            <td style={{ padding: '12px' }}>
                              <input
                                ...
                                style={{ padding: '8px', fontSize: '12px', width: '100px' }}
                              />
                            </td>
                            <td style={{ padding: '12px' }}>
                              <input
                                ...
                                style={{ padding: '8px', fontSize: '12px', width: '80px' }}
                              />
                            </td>
                            <td style={{ padding: '12px' }}></td>
                            <td style={{ padding: '12px' }}></td>
                          ...
                          <>
                            ...
                            <td style={{ padding: '12px', fontSize: '14px' }}>
                              <span style={{
                                padding: '4px 8px',
                                background: (product.stock_quantity || 0) < 5 ? '#ffebee' : '#f5f5f5',
                                color: (product.stock_quantity || 0) < 5 ? '#c62828' : '#000',
                                fontSize: '12px',
                                fontWeight: '600'
                              }}>
                            ...
                            <td style={{ padding: '12px', textAlign: 'center' }}>
                              <button
                                onClick={() => openColorManager(product.id)}
                                style={{
                                  background: '#f5f5f5',
                                  border: '1px solid #000',
                                  padding: '4px 8px',
